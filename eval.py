...
if __name__ == "__main__":
    ...
    default_output_filename = f"eval_captions/coco_val_results_{timestamp}.json"
    ...
    parser.add_argument("--num-test-images", type=int, default=1000,
