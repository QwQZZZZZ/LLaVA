...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str,
                        default='/home/moting/llava_project/checkpoints/llava-v1.5-7b-lora-coco-caption_20250619_081438',
                        help="LLaVA 模型路径。如果是完整的LLaVA模型,直接指向其目录,如果是LoRA检查点,则指向LoRA目录。")
    parser.add_argument("--model-base", type=str, default="/home/moting/llava_project/models/llava-v1.5-7b",
    ...
    default_output_filename = f"/home/moting/llava_project/eval_results/q_former_coco_val_results_{timestamp}.json"
    ...
    parser.add_argument("--num-test-images", type=int, default=32,
