...
#SBATCH --gres=gpu:2                  # 指定作业需要的 GPU卡数量为 4
...
VISION_TOWER="/lab/zhangjg_lab/30028000/llava/models/clip-vit-large-patch14-336"
...
# --- 输出路径 ---
OUTPUT_DIR="./checkpoints/llava-v1.5-7b-lora-coco-caption"
