...
OUTPUT_DIR="/home/moting/checkpoints/llava-q_former-lora-coco-caption_$(date +%Y%m%d_%H%M%S)"
...
QFORMER_EMBED_DIM=768
NUM_QUERY_TOKENS=32
QFORMER_NUM_HEADS=12
QFORMER_NUM_LAYERS=6
QFORMER_FFN_DIM=3072
QFORMER_DROPOUT=0.1
QFORMER_GRAD_CLIP=1.0
